var validatorMap = {
    required: [LANG_formplus.validate.required, function(a, b, c) {
        return "select-one" == c || "select" == c ? (c = a.selectedIndex,
        b = a.options[c].value,
        0 <= c && "" != b && "_NULL_" != b) : null  !== b && 0 !== b.length
    }
    ],
    ...
    unsignedint: [LANG_formplus.validate.unsignedint, function(a, 
    b) {
        return !/[^\d]/.test(b) && 0 < b
    }
    ],
    ...
    alphanum: [LANG_formplus.validate.alphanum, function(a, b) {
        return !/\W/.test(b) || 
        /^[\u4e00-\u9fa5a-zA-Z0-9_\-]+$/.test(b)
    }
    ],
	/*** added by y.y 20180813 ***/
    alphach: [LANG_formplus.validate.alphach, function(a, b) {
        return /^[\u4e00-\u9fa5a-zA-Z]+$/.test(b)
    }
    ],
    // 20181114 add （）
    alphachnum: [LANG_formplus.validate.alphachnum, function(a, b) {
        return !/\W/.test(b) || 
        /^[\u4e00-\u9fa5a-zA-Z0-9_\-\uff08\uff09]+$/.test(b)
    }
    ],
	/*** end ***/
    /*** added by wonder 20170613 ***/
    sdpassword: [LANG_formplus.validate.sdpassword, function(a, b) {
        return b === null || b === "" || /^(?=.*[0-9].*)(?=.*[A-Z].*)(?=.*[a-z].*).{6,20}$/.test(b);
    }],
    /*** end ***/
    ...
    emaillist: [LANG_formplus.validate.email, function(a, b) {
        return null  === b || 
        "" == b || /^(?:[a-z\d][a-z\d_.]*@[\w-]+(?:\.[a-z]{2,})+[,;\s]?)+$/i.test(b)
    }
    ],
    mobile: [LANG_formplus.validate.mobile, function(a, b) {
        return null  === b || "" == b || /^0?1[3456789]\d{9}$/.test(b)
    }
    ],
    tel: [LANG_formplus.validate.tel, function(a, b) {
        return null  === b || "" == b || /^(0\d{2,3}-?)?[2-9]\d{5,7}(-\d{1,5})?$/.test(b)
    }
    ],
    phone: [LANG_formplus.validate.phone, function(a, b) {
        return null  === b || "" == b || /^0?1[3456789]\d{9}$|^(0\d{2,3}-?)?[2-9]\d{5,7}(-\d{1,5})?$/.test(b)
    }
    ],
  ...
  , validate = function(a, b, c) {
    ...
    if (!a)
        return !0;
    var d = [];
    (a.match("form") || "all" == b ? a.getElements("[vtype], [pattern]") : 
    Array.from(a)).each(function(b, f) {
        if (!b.isVisible() || !b.get("vtype"))
            return !0;
        ...
        g = g.clean().include(l));
        b.get("required") && (g = ["required"].combine(g),
        b.erase("required"));
        if (!g.length)
            return !0;
        g.every(function(d, f) {
            ...
            if (h(b, b.get("value"), b.type, a.match("[vtype]") || a.match("[pattern]") ? c || a.getParent("form") || a.getParent() : a, k))
                return s && b.retrieve("tips_instance", {
                    hide: function() {}
                }).hide(!0),
                t && b.removeClass("caution-input"),
				t && b.removeClass("error_shundian"),
                !0;
            s && s.destroy();
            ...
            if (!1 !== b.bindEvent) {
                ...
                b[l] = function(b) {
                    b = b || window.event;
                    /mouseout$/i.test(b.type) && this.contains($(b.target || b.srcElement)) || (validate(this, "", a.match("[vtype]") || a.match("[pattern]") ? a.getParent("form") || a.getParent() : a),
                    s && this.retrieve("tips_instance", {
                        hide: function() {}
                    }).hide(!0),
                    t && this.removeClass("caution-input"));
                    this[l] = null 
                }
            }
            t && b.addClass("caution-input");
			t && b.addClass("error_shundian");
			t && b.removeClass("right_form");
            return !1
        }) || d.push(b)
    });
    return d.length ? (d.shift().focus(),
    !1) : !0
}
  , formTips = 
(new Class({
    ...
    toElement: function() {
        if (!this.element) {
            ...
            this.element = a.single && document.id(c) ? document.id(c) : 
            new Element(b,{
                id: c,
    ...
    show: function(a, b) {
        ...
        a && (this.element.getElement(".caution-content").innerHTML = 
        a);
        this.element.show();
        this.hidden = !1;
        !isNaN(b.autohide) && 0 < b.autohide && (clearTimeout(this.timer),
        this.timer = this.hide.delay(1E3 * b.autohide, this));
    ...
    hide: function(a) {
        ...
        if (this.hidden)
            return this;
        this.element || document.id(this);
        !1 !== a ? (this.element.destroy(),
        this.element = null ) : this.element.hide();
        this.hidden = !0;
...
function changeVerify(a, b) {
    Array.from(a).each(function(a) {
        var d, e;
        "IMG" === a.tagName ? (e = a,
        d = a.getAttribute("src").split("?")[0]) : "A" === a.tagName && (e = a.getPrevious("img"),
...
var Placeholder = {
    ...
    create: function(a) {
        var b = this;
        Array.from(a).each(function(a) {
            if (!b.support && a.get && a.get("placeholder")) {
                var d = a.get("placeholder");
                a.store("placeholder", b.build(a, d));
                b.show(a);
                a.addEvents({
                    focusin: function(a) {
                        b.hide(this)
    ...
    show: function(a) {
        !this.support && "" === a.value && a.isVisible() && "hidden" !== a.getStyle("visibility") && a.retrieve("placeholder").setStyle("visibility", "visible")
    },
    hide: function(a) {
        this.support || a.retrieve("placeholder", 
        a).setStyle("visibility", "hidden")
    }
};
window.addEvent("domready", function(a) {
    document.forms.length && (passwordStrength.init($$("form .auto-password-check-handle")),
    changeVerify($$("form .auto-change-verify-handle"), !0),
    $$("form .action-remember-account").each(function(a) {
...
(function() {
    this.Sync = new Class({
        ...
        _progress: function(a) {
            ...
            if (a) {
                if (this.options.progress)
                    return this.options.progress.call(this, a);
                var c = a.redirect, d;
        ...
        _injectTip: function(a, b) {
            ...
            if (d) {
                ...
                if (c && this.tipElem)
                    return this.tipElem.set("html", b);
                (new Element("div." + a + "." + f,{
                    html: b
                })).inject(d, e)
            }
        ...
        _isCheck: function(a) {
            ...
            return "element" !== 
            typeOf(a) || validate(a) ? !0 : !1
        },
        send: function(a) {
            var b = this.sponsor;
            if (b) {
                if (b.hasClass(this.options.disabled) || !this._isCheck(a) || this._progressCache(b))
                    return;
                this._request(b)
            }
            this.parent(a)
    ...
    this.async = function(a, b, c) {
        ...
        if ("object" === typeOf(b))
            ...
            if (c && !1 === c.async)
                return
        } else if (b = a.retrieve("ajax_cache", !1))
            return b.send();
        (new Sync(a,c)).send()
    }
    ;
    ...
    $(document.html).addEvent("click", function(a) {
        ...
        if (c && 9 !== c.nodeType && !c.disabled) {
            ...
            if (!d || "false" !== d.get("async")) {
                if ("submit" === c.type && d && d.get("target"))
                    return async(c, d, {
                        async: !1
                    });
                if ("submit" === c.type && "_request" !== c.get("rel"))
                    return async(c, d);
                var b = c.get("rel")
                  , e = Event_Group[b];
                if (e) {
...
var Popup = new Class({
    ...
    initialize: function(a, b) {
        if (a) {
            ...
            this.title = this.header.getElement("h2") || 
            e;
            ...
            "string" === typeOf(a) && ("ajax" === b.async ? this.requestCache(Object.merge({
                url: a + "",
                update: this.content
            }, c)) : (d = c.data ? a + (1 < a.indexOf("?") ? "&" : "?") + c.data : a + "",
            this.content.getElement("iframe").set("src", d).addEvent("load", (c.onSuccess || function() {}
            ).bind(this))));
    ...
    build: function(a, b) {
        var c = this.options, d = c.id ? document.id(c.id) : document.getElement("[data-single=true]." + c.component.container), 
        e;
        "element" === typeOf(b) ? e = b.tagName.test(/^(?:IMG|OBJECT|SCRIPT)$/) ? b : b.innerHTML : "string" === typeOf(b) && (e = "ajax" === c.async ? c.ajaxTpl : c.frameTpl);
        if (c.single && d)
            return "element" === typeOf(b) && (d.retrieve("instance").content.innerHTML = e),
            d;
    ...
    getTemplate: function(a, b) {
        ...
        if ("element" === typeOf(a) && /^(?:script|textarea|template)$/i.test(a.tagName))
            return document.id(a).get("value") || document.id(a).get("html");
        b = b || c.type;
    ...
    show: function() {
        ...
        Browser.ie6 && this.options.useIframeShim && (new Element("iframe",{
            frameborder: 0,
            src: "about:blank",
            style: "position:absolute;z-index:-1;border:0 none;filter:alpha(opacity=0);top:" + (-this.container.getPatch().y || 0) + "px;left:" + (-this.container.getPatch().x || 
            0) + "px;width:" + (this.container.getSize().x || 0) + "px;height:" + (this.container.getSize().y || 0) + "px;"
        })).inject(this.container);
        var a = this.options.effect;
        a ? (!0 !== a && "opacity" !== a.style || this.container.setStyle("opacity", a.from || 0).setStyle("visibility", "visible"),
    ...
    hide: function() {
        ...
        this.options.single ? a ? this.stopTimer().container.setStyles({
            ...
            opacity: 0,
            visibility: "hidden"
        }) : this.container.setStyle("display", "none") : (a ? this.container.timer = 
        (new Fx.Tween(this.container,{
            duration: a.duration || 400,
            link: "ignore",
            onComplete: function() {
            ...
            .bind(this)
        })).start(a.style || "opacity", a.to || 1, a.from || 0) : this.container.destroy(),
    ...
    stopTimer: function() {
        this.container.timer && (clearTimeout(this.container.timer),
    ...
    position: function() {
        ...
        !this.size.y && Browser.ie && 8 > Browser.version && this.container.getSize().y >= this.doc.getSize().y && document.id(this.body).setStyle("height", 
        Math.min(a.minHeight.toInt(), this.doc.getSize().y) - this.container.getPatch().y);
    ...
    setHeight: function(a) {
        a = a || this.container;
        this.content.setStyle("height", (!this.size.y && Browser.ie && 8 > Browser.version ? this.body.getStyle("height").toInt() : a.getSize().y - this.container.getPatch().y) - document.id(this.body).getPatch().y - 
        document.id(this.header).getOuterSize().y - this.content.getPatch().y)
    },
    setTitle: function(a) {
    ...
    requestCache: function(a) {
        ...
        if (!a)
            return null ;
        if (a.target && a.cache && (b = a.target.retrieve("request:cache")))
            return b.success(b.response.text);
...
Element.implement({
    fixed: function(a) {
        ...
        if (Browser.ie6) {
            ...
            a = function() {
                b && this.getStyle("left").toInt() >= document.body.clientWidth || c && this.getStyle("top").toInt() >= document.body.clientHeight || (d = window.getScroll(),
                this.set("morph", {
                    duration: 200,
        ...
        if (!1 !== a) {
            if (!this.retrieve("pin:_pinned")) {
                ...
                if (Browser.ie6) {
                    ...
                    this.setStyle("position", "fixed").setStyles(d);
            ...
            Browser.ie6 && (window.removeEvent("scroll", this.retrieve("pin:_scrollFixer")),
...
var Mask = new Class({
    ...
    show: function() {
        if (this.hidden) {
            ...
            var a = this.options.effect;
            a ? (!0 !== a && "opacity" != a.style || this.element.setStyle("opacity", a.from || 0).setStyle("visibility", "visible"),
            ...
            var getmaskindex = $$('div[rel=mask]').getStyle('z-index');
            $$('div[rel=mask]').setStyle('z-index',getmaskindex-1);
            // console.log(getmaskindex);
            return this
        }
    },
    hide: function() {
        if (!this.hidden) {
            ...
            "opacity", a.to, a.from || 0) : this.element.destroy();
            this.target == window && document.html.setStyles({
                height: "",
                overflow: ""
            });
...
Element.Properties.mask = {
    set: function(a) {
        ...
        b && ((b = document.id(b.element)) && b.destroy(),
        this.eliminate("mask"));
...
var Dialog = (new Class({
    ...
    alert: function() {
        ...
        Dialog.instance(new Element("div",{
            html: '<div class="pop-attention-main"><div class="figure"><dfn class="alert">!</dfn><span class="mark">' + 
            a.msg + '</span></div><div class="bottom"><button type="button" class="btn btn-caution action-confirm"><span><span>' + (b.confirmText || "确定") + "</span></span></button> </div></div>"
        }), Object.merge({
            width: 650,
            title: "友情提示",
            modal: window,
    ...
    confirm: function() {
        ...
        Dialog.instance(new Element("div",{
            ...
            (b.cancelText || "取消") + "</span></span></button></div></div>"
        }), Object.merge({
            width: 650,
            title: "友情提示",
            modal: window,
    ...
    tips: function() {
        ...
        Dialog.instance(new Element("div",{
            html: '<span class="icon">&#x24;</span><p>' + a.msg + '</p><div class="bottom"><button type="button" class="btn btn-caution btn-small action-confirm" data-return="1"><span><span>' + (b.confirmText || "确定") + '</span></span></button><button type="button" class="btn btn-simple btn-small action-cancel" data-return="0"><span><span>' + 
            (b.cancelText || "取消") + "</span></span></button></div>"
        }), Object.merge({
            width: "",
            modal: !1,
  ...
  , Tips = new Class({
    ...
    initialize: function() {
        ...
        if (!b || "elements" === typeOf(b) && !b.length)
            return null ;
    ...
    build: function(a) {
        ...
        this.container = document.id("xtips_container") || (new Element(b + "#xtips_container." + this.options["class"],{
            html: c
        })).inject("inline" == this.options.type && typeOf("element" == 
    ...
    show: function(a, b, c) {
        ...
        var d = b.getPosition()
          ...
          , g = JSON.decode(g) || {}
          , h = {};
        "inline" !== this.options.type && (-1 != ["rightcenter", "rc", 
        "cr"].indexOf(a) ? h = {
            left: d.x + f.x,
        ...
        this.hidden = !1;
        "autohide" == c && (this.stopTimer(b),
        b.timer = this.hide.delay(this.options.hideDelay, this));
        return this
    },
...
var ToolTip = (new Class({
    ...
    initialize: function(a, b) {
        ...
        this.content = this.toolTip.getElement("." + this.options["class"] + 
        "-content");
    ...
    show: function() {
        this.element.get("data-tooltip-displayed") || 
        (this.element.set("data-tooltip-displayed", !0),
        this.toolTip.show(),
        this.position(),
    ...
    instance: function(a, b, c) {
        var d, e, f = ["string", "element"].contains(typeOf(b)), g = f ? b : c || null ;
        b = f ? c || {} : b;
...
function(a, b) {
    ...
    function(a, b) {
        var c, d;
        ["string", "element"].contains(typeOf(a)) ? (c = document.id(a),
        d = b) : (d = a,
    ...
    ;
    c.setTargetOffset = function(a, 
    b) {
        "object" == typeof a && a.to && a.offset ? (b = a.offset,
        a = a.to) : b = b || {
            x: 0,
            y: 0
        };
...
.extend({
    getCoordinate: function(a) {
        if ("object" == typeof a && (a.x || 0 === a.x) && (a.y || 0 === a.y)) {
            if (-1 < "ltbr".indexOf(a.x) && -1 < "ltbrcm".indexOf(a.y))
                return a;
            if (-1 < "cm".indexOf(a.x))
                return {
                    x: a.y,
...
function Message(a, b, c, d, e) {
    ...
    g && (g = g.retrieve("instance")) && (g.content.innerHTML = a,
    g.show());
...
function maxZindex(a, b) {
    ...
    if (a.length) {
        var d = a.filter(function(a) {
            if (1 == a.nodeType && !["script", "link", "base", "style"].contains(a.tagName.toLowerCase()))
                return ["absolute", "relative", "fixed"].contains(a.getStyle("position"))
        });
        if (d.length)
            for (var e = 0, f = d.length; e < f; e++) {
                var g = d[e].getStyle("z-index");
                if (d[e].getStyle("display") == 'none') {
                    continue;
                }
...
;var AutoPlay = new Class({
    ...
    _autoInit: function(a) {
        this.options.autoplay && (this.autofn = a || function() {}
        ,
  ...
  , LazyLoad = new Class({
    ...
    loadCustomLazyData: function(a, b) {
        var c, d, e = this.options.textarea, f = this.options.img;
    ...
    isAllDone: function() {
        var a = 
        this.options.lazyDataType, b = this.options[a], c, d, e = "img" === a;
        if (a && this.container)
            for (a = this.container.getElements(a),
            c = 0,
            d = a.length; c < d; c++)
  ...
  , DataLazyLoad = new Class({
    ...
    initialize: function(a, b) {
        ...
        this.containers.length && (window.Shop && (this.options.config.placeholder = Shop.url.placeholder),
        this.lazyinit())
    },
    lazyinit: function() {
    ...
    filterImg: function(a) {
        ...
        if ("manual" === 
        this.options.config.mod) {
            if (c)
                return e && (a.src = e),
                !0
        } else if ($(a).getOffsets().y > d && !c)
            return a.set(b, a.src),
  ...
  , Tabs = new Class({
    ...
    getMarkup: function() {
        var a = this.container, b = this.options, c;
    ...
    lrbtn: function() {
        ...
        ["prev", "next"].each(function(b) {
            this[b + "btn"] = this.container.getElements(this.options[b]).addEvent("click", function(c) {
                if (!this.hasClass(a.options.disableCls))
                    a[b]()
            })
        }, 
        this);
...
Tabs.Effects = {
    ...
    fade: function(a, b) {
        if (1 !== a.length)
            throw Error("fade effect only supports steps == 1.");
        var c = a[0]
          , d = b[0];
    ...
    scroll: function(a, b, c, d) {
        ...
        var g = "scrollx" === b.effect
          ...
          , m = g ? "left" : "top";
        b = -n * c;
        var r, q = "FORWARD" !== d, m = "absolute" == k.getStyle("position") ? m : "margin-" + m;
        (r = q && 0 === a && c === h - 1 || !q && a === h - 1 && 0 === 
        c) && (b = e.call(this, !0));
...
var Switchable = new Class({
    ...
    effInit: function() {
        ...
        if ("none" !== b)
            ...
            case "scrollx":
            case "scrolly":
                "absolute" == a.position ? (d.setStyle("position", "absolute"),
                d.getParent().setStyles({
                    position: "relative"
                })) : "relative" == a.position && d.setStyle("position", "relative");
                "scrollx" === b && (a.isFloat && c.setStyle("float", "left"),
                d.setStyle("width", g / e * this.viewSize[0]));
                break;
            case "fade":
                var k = 
                f * e, n = k + e - 1, l;
  ...
  , Accordion = new Class({
    ...
    switchView: function(a, b, c) {
        var d = this.options;
        b = b[0];
        d.multiple ? (this.triggers[c].toggleClass(d.activeClass),
        b.setStyle("display", "none" == b.getStyle("display") ? "block" : "none")) : (a[0].setStyle("display", "none"),
...
Switchable.autoRender = function(a, b) {
    var c = a || ".auto-bind-widget", c = $(b || document.body).getElements(c), d;
    Array.from($$("img[data-src]"), $$("textarea.action-lazyload")).length && (d = $(document.body).get("data-lazyload-config") || "",
    new DataLazyLoad(JSON.decode(d)));
    c.length && c.each(function(a) {
        var b = a.get("data-widget-type");
        if (b && -1 < "Tabs Switchable Slide DropMenu Accordion DataLazyLoad".indexOf(b))
            try {
                d = a.get("data-widget-config") || "";
                if ("DataLazyLoad" === b)
                    return new window[b](JSON.decode(d),a);
                new window[b](a,
                JSON.decode(d))
            } catch (c) {}
    })
